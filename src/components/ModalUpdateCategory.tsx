...
import { UpdateCategory, updateProduct } from '@/services/update';
...
export const ModalUpdateCategory = ({params}:ParamsProduct) => {
    ...
    const onSubmit: SubmitHandler<CategoryType> = (data) => 
         UpdateCategory( params.id, data).then((res)=>{
         if(res.status=== 200){
...
>
  <Box sx={style} >
        <h1 className='text-center text-xl font-bold'>Update Category</h1>
